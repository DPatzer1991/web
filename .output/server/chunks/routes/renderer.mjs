import { u as useRuntimeConfig, e as encodePath, j as joinRelativeURL, f as defineRenderHandler, h as getQuery, c as createError, i as destr, k as getRouteRules, l as relative, m as joinURL, n as getResponseStatusText, o as getResponseStatus, p as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"DNS3L","htmlAttrs":{"lang":"en"}};
...
const entryFileName = "C8X29rKN.js";
